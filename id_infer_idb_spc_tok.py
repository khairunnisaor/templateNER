...
model = MBartForConditionalGeneration.from_pretrained(sys.argv[1]) # './outputs/id_best_model_indobart_500_2'
...
score_list = []
file_path = './data/idner2k/test_bio_spc_tok.txt'
guid_index = 1
examples = []
...
for example in examples:
    ...
    print('Word:', words_list[num_point])
...
with open(sys.argv[2], 'w') as f0: # './id_pred_indobart_500_2.txt'
