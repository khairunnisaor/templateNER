...
train_data = pd.read_csv(sys.argv[1], sep=',').values.tolist()
train_df = pd.DataFrame(train_data, columns=["input_text", "target_text"])

eval_data = pd.read_csv("./data/idner2k-fewshot/dev_id_200_4.csv", sep=',').values.tolist()
...
model_args = {
    ...
    "max_length": 25,
    "manual_seed": int(sys.argv[4]), #4,
    "save_steps": 11898,
    "gradient_accumulation_steps": 1,
    "output_dir": sys.argv[2], # "./exp/template_indobart_200_5"
    "best_model_dir": sys.argv[3], # "./outputs/best_model_lalala"
}
